    ...
    <HelmetProvider>
      ...
      <div className="player">
        <div className="player-controls">
          <i className="fa fa-arrow-left" onClick={() => nav(`/${type}/${id}`)}></i>

          {type === 'series' && episode < maxEpisodes && <i className="fa fa-forward-step right" onClick={() => nav(`/watch/${id}?s=${season}&e=${episode + 1}&me=${maxEpisodes}`)}></i>}
        </div>
